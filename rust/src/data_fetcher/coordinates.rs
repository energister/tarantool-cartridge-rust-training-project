...
pub fn get_coordinates(place_name: String) -> Result<Option<api::CoordinatesResponse>, Box<dyn std::error::Error>> {
...
fn convert(geo_data: MeteoApiGeocodingResponse) -> api::CoordinatesResponse {
    ...
    api::CoordinatesResponse { coordinates }
}